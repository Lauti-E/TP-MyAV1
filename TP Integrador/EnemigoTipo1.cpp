...
void EnemigoTipo1::InicializarTexturas() {
...
void EnemigoTipo1::DibujarEnemigos(RenderWindow& ven) {
	ven.draw(sprEnemigo);
}

void EnemigoTipo1::PosicionInicial() {
